...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Address",
      details: [
        "Pole Workspaces 33/2 Racha, Galaxy 21st,",
        "Marenahalli, Bangalore North, Vijayanagar,",
  ...
  const faqs = [
    {
      ...
      answer:
        "Basic computer literacy and passion for learning. No prior programming experience required for beginner courses. We welcome students from all educational backgrounds.",
    },
    {
      question: "Do you provide job placement assistance in India?",
      answer:
        "Yes, we have a 78% placement rate with 120+ partner Indian companies including TCS, Infosys, Wipro, and more. Dedicated career support with resume building and interview preparation.",
    },
    {
      question: "Are there any EMI or financing options available?",
      answer:
        "We offer flexible EMI options, education loans through partner banks, and income-share agreements to make quality education accessible to all Indian students.",
    },
    {
      question: "What is the class schedule for working professionals?",
      answer:
        "We offer flexible batches including weekday evenings, weekend batches, and online options to accommodate working professionals and college students across India.",
    },
    {
      question: "Do you provide certificates recognized by Indian companies?",
      answer:
        "Yes, we provide industry-recognized certificates and also help with NASSCOM and other relevant certifications valued by Indian IT companies.",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Ready to transform your career in the Indian IT industry? Let's
              discuss how we can help you achieve your goals with 78% placement
              success.
            </p>
          </div>
        </div>
...
*/}
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p className="text-gray-400 mb-6">
                  Reach out to us for career guidance, course information, or
                  placement assistance. We're here to help you succeed in the
                  Indian IT industry.
                </p>
              </div>
              <div
                ...
                className={getAnimationClass(
                  "contact-info-grid",
                  "grid grid-cols-1 sm:grid-cols-2 gap-6 delay-300"
                )}
              >
                {contactInfo.map((info, index) => (
                  <div
                    ...
                    className={getAnimationClass(
                      `contact-card-${index}`,
                      `bg-gray-900 p-6 rounded-lg hover:-translate-y-2 transition-all duration-200 delay-${
                        (index + 1) * 100
                      }`
                    )}
                  >
              ...
              <div
                ...
                className={getAnimationClass(
                  "map-section",
                  "bg-gray-900 p-6 rounded-lg delay-500"
                )}
              >
                <h3 className="font-semibold mb-4">
                  Find Our Bangalore Campus
                </h3>
              ...
              <div
                ...
                className={getAnimationClass(
                  "stats-section",
                  "bg-gradient-to-br from-yellow-400 to-yellow-500 p-6 rounded-lg text-black delay-600"
                )}
              >
                <h3 className="font-semibold mb-4 text-center">
                  Learnovia India Impact
                </h3>
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div
                ...
                className={getAnimationClass(
                  `faq-${index}`,
                  `bg-black p-6 rounded-lg border border-gray-800 delay-${
                    index * 100
                  }`
                )}
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div
              ...
              className={getAnimationClass(
                "office-hours",
                "bg-gray-900 p-8 rounded-lg text-center hover:-translate-y-2 transition-all duration-200"
              )}
            >
            ...
            <div
              ...
              className={getAnimationClass(
                "student-support",
                "bg-gray-900 p-8 rounded-lg text-center hover:-translate-y-2 transition-all duration-200 delay-200"
              )}
            >
              ...
              <p className="text-yellow-400 mt-4">
                We're here when you need us across India
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold mb-4">Our Center In India</h2>
