        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Comprehensive training programs designed to meet Indian industry demands and career goals.
              Get placement-ready with our industry-partnered curriculum.
            </p>
          </div>
      ...
      <section ref={processRef} className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "1", title: "Skill Assessment", description: "Comprehensive evaluation and personalized learning path creation" },
              { step: "2", title: "Industry Training", description: "Hands-on learning with real projects and expert guidance" },
              { step: "3", title: "Project Practice", description: "Industry projects and portfolio development for Indian companies" },
              { step: "4", title: "Job Placement", description: "Dedicated placement support and interview preparation" }
            ].map((process, index) => (
              <div 
                key={index}
      ...
      <section ref={ctaRef} className="py-20">
        <div className={`max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center transition-all duration-1000 ${
          ...
          <p className={`text-xl text-gray-400 mb-8 transition-all duration-1000 delay-400 ${
            ...
            Join 850+ successful Indian professionals who started their journey with our courses and got placed in top companies.
          </p>
          <div className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-600 ${
            ctaVisible 
              ? 'opacity-100 translate-y-0' 
